...
namespace NewsPortal.Data
{
    public class DataSeeder
    {
        public static void InitNews(DataContext context)
        {
            ...
            {
                new NewsModel { Title = "What would the world do without GPS?", 
                ...
                new NewsModel { Title = "The surprising downsides of empathy",
                ...
                new NewsModel { Title = "How a brilliant biologist was failed by science",
                ...
                new NewsModel { Title = "The return of Europe’s largest beasts",
                ...
                new NewsModel { Title = "The ancient trade holding back the Sahara Desert",
