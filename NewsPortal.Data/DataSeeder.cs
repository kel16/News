...
namespace NewsPortal.Data
{
    public class DataSeeder
    {
        public static void InitNews(DataContext context)
        {
            ...
            {
                new News { 
                    Title = "What would the world do without GPS?", 
                ...
                new News { 
                    Title = "The surprising downsides of empathy",
                ...
                new News { 
                    Title = "How a brilliant biologist was failed by science",
                ...
                new News { 
                    Title = "The return of Europe’s largest beasts",
                ...
                new News { 
                    Title = "The ancient trade holding back the Sahara Desert",
